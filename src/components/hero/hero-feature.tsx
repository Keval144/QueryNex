...
function BentoFeatures() {
  return (
    <section className="min-h-screen py-8 md:py-16 lg:py-20" id="features">
      <div className="mb-8 text-center text-4xl md:mb-12 md:text-5xl lg:mb-16 lg:text-6xl">
        Features
      </div>

      <div className="font-inter mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-4 md:hidden">
          ...
          {/* Device Image 1 */}
          <div
            className="bg-card min-h-[200px] rounded-3xl bg-cover bg-center bg-no-repeat shadow-[0_20px_30px_-10px_rgba(16,16,39,0.07)]"
            style={{
              backgroundImage:
                "url('https://www.shutterstock.com/shutterstock/photos/2382056221/display_1500/stock-vector-young-woman-writing-code-on-a-desktop-computer-software-developer-at-work-workplace-with-modern-2382056221.jpg')",
            }}
          ></div>
        ...
        <div className="hidden md:grid md:grid-cols-2 md:gap-6 lg:hidden">
          ...
          <div
            className="bg-card min-h-[250px] rounded-3xl bg-cover bg-center bg-no-repeat shadow-[0_20px_30px_-10px_rgba(16,16,39,0.07)]"
            style={{
              backgroundImage:
                "url('https://www.shutterstock.com/shutterstock/photos/2382056221/display_1500/stock-vector-young-woman-writing-code-on-a-desktop-computer-software-developer-at-work-workplace-with-modern-2382056221.jpg')",
            }}
        ...
        <div className="hidden auto-rows-fr grid-cols-[4fr_3fr_3fr] gap-6 lg:grid">
          {/* Cloud Solutions */}
          ...
          {/* Device 1 */}
          <img
            className="bg-card rounded-[2.5rem] bg-cover bg-center bg-no-repeat shadow-[0_20px_30px_-10px_rgba(16,16,39,0.07)] h-max"
